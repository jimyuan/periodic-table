...
import moreData from 'ASSETS/data.json'
...
export default new Vuex.Store({
  state: {
    elements: periodicTable.map((item, index) => Object.assign(item, {
      cnName: cnNames[index],
      meltingPoint: moreData[index]['Melting Point'],
      boilingPoint: moreData[index]['Boiling Point'],
      yearDiscovered: moreData[index].Discovered || item.yearDiscovered,
      discription: moreData[index]['Element Description'],
      isotopes: moreData[index].Isotopes
    })),
    version: 'en'
  },
  mutations: {
